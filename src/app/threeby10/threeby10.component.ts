...
import html from "./threeby10.component.html";
import css from "./threeby10.component.css";

export class Threeby10Component extends EzComponent {
    ...
    @BindStyle("cell-26", "backgroundColor", (value: boolean) =>
        value ? "grey" : "red",
    )
    public backgroundColor26: boolean = true;
    @BindStyle("cell-27", "backgroundColor", (value: boolean) =>
        value ? "grey" : "red",
    )
    public backgroundColor27: boolean = true;
    @BindStyle("cell-28", "backgroundColor", (value: boolean) =>
        value ? "grey" : "red",
    )
    public backgroundColor28: boolean = true;
    @BindStyle("cell-29", "backgroundColor", (value: boolean) =>
        value ? "grey" : "red",
    )
    public backgroundColor29: boolean = true;
    @BindStyle("cell-30", "backgroundColor", (value: boolean) =>
        value ? "grey" : "red",
    )
    public backgroundColor30: boolean = true;
    ...
    private toggleCell(cellNumber: number) {
        switch (cellNumber) {
            ...
            case 25:
                ...
                break;
            case 26:
                this.backgroundColor26 = !this.backgroundColor26;
                break;
            case 27:
                this.backgroundColor27 = !this.backgroundColor27;
                break;
            case 28:
                this.backgroundColor28 = !this.backgroundColor28;
                break;
            case 29:
                this.backgroundColor29 = !this.backgroundColor29;
                break;
            case 30:
                this.backgroundColor30 = !this.backgroundColor30;
                break;
        }
        ...
        if (
            ...
            !this.backgroundColor17 &&
            !this.backgroundColor18 &&
            !this.backgroundColor19 &&
            !this.backgroundColor20 &&
            !this.backgroundColor21 &&
            !this.backgroundColor22 &&
            !this.backgroundColor23 &&
            !this.backgroundColor24 &&
            !this.backgroundColor25 &&
            !this.backgroundColor26 &&
            !this.backgroundColor27 &&
            !this.backgroundColor28 &&
            !this.backgroundColor29 &&
            !this.backgroundColor30
        ) {
            EzDialog.popup(
                this,
                `You've won the game!`,
    ...
    click26() {
        this.toggleCell(26);
        this.toggleNeighbors(26);
    }
    @Click("cell-27")
    click27() {
        this.toggleCell(27);
        this.toggleNeighbors(27);
    }
    @Click("cell-28")
    click28() {
        this.toggleCell(28);
        this.toggleNeighbors(28);
    }
    @Click("cell-29")
    click29() {
        this.toggleCell(29);
        this.toggleNeighbors(29);
    }
    @Click("cell-30")
    click30() {
        this.toggleCell(30);
        this.toggleNeighbors(30);
    }
}
