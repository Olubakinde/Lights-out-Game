...
import html from "./threeby8.component.html";
import css from "./threeby8.component.css";

export class Threeby8Component extends EzComponent {
    ...
    // Function to randomly set any cell to show red
    private setRandomRed() {
        const randomCell = Math.floor(Math.random() * 24) + 1; // Generate random number between 1 and 24
        this.toggleCell(randomCell);
    }
