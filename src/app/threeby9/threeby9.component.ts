...
import html from "./threeby9.component.html";
import css from "./threeby9.component.css";

export class Threeby9Component extends EzComponent {
    ...
    // Randomly select a cell and toggle its background color
    private setRandomRed() {
        const randomCell = Math.floor(Math.random() * 27) + 1;
        this.toggleCell(randomCell);
    }
